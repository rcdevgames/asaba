...
export class GeneralOpMeter {
  ...
  image2: string = null;
  image3: string = null;
  meter : {copy_black : number, copy_color : number, print_black :number, print_color : number, total :number,fax : number, total_bw : number, total_color : number}
    		...
    		buttons : [
    			{
    				...
    				handler : () => {
    					...
    					var detailMeter = [{
    							...
    							name : 'copy_color',
    							qty : this.meter.copy_color
    						}, {
    							name : 'copy_black',
    							qty : this.meter.copy_black,
    						}, {
    							name : 'total',
